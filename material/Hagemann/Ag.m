...
n = [9.91 2.84 1.41 0.91 0.67 0.28 0.27 0.27 0.24 0.23 0.23 0.21 0.23 0.30 0.53 0.73 1.30 1.61 1.73 1.75 1.73 1.69 1.61 1.55 1.45 1.34 1.25 1.18 1.14 1.16 1.33 1.46 1.52 1.61 1.66 1.72 1.64 1.56 1.42 1.33 1.28 1.27 1.29 1.35 1.37 1.34 1.26 1.17 1.10 1.04 0.99 0.95 0.91 0.90 0.89 0.89 0.89 0.90 0.91 0.92 0.93 0.93 0.92 0.90 0.88 0.86 0.89 0.89 0.90 0.90 0.90 0.90 0.89 0.88 0.89 0.88 0.87 0.87 0.87 0.88 0.88 0.88 0.87 0.83 0.85 0.85 0.85 0.85 0.85 0.85 0.85 0.86 0.87];
...
switch plotstyle
    ...
    case eps_wvlen
        ...
        %axis([1e2 1e4 1e-2 1e2])
    case eps_omega
        plot(2*pi./wvlen, real(eps), 2*pi./wvlen, -imag(eps))
        legend('\epsilon_1', '\epsilon_2', 'Location', 'SouthEast');
        xlabel '\omega (c/nm)'
    case q_omega
        omega = 2*pi./wvlen;
